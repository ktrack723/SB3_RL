...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        apple_dx = head_x - self.apple_position[0]
        apple_dy = head_y - self.apple_position[1]

        snake_length = len(self.snake_position)
        
        observation = [head_x, head_y, apple_dx, apple_dy, snake_length] + (
    ...
    def reset(self):
        ...
        # head_x, head_y, apple_dx, apple_dy, snake_length, previous_move
        head_x = self.snake_head[0]
        head_y = self.snake_head[1]
        apple_dx = head_x - self.apple_position[0]
        apple_dy = head_y - self.apple_position[1]
